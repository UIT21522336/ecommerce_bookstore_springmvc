                            ...
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="form-sample" method="post" action="/admin/users/update"
                                            enctype="multipart/form-data" modelAttribute="modelUser">
                                            <div class="row mb-5" style="text-align:center;">
                                                <div id="previewImage" style="margin:auto;">
                                                    <img src="/resources/admin/images/avatar/${modelUser.getAvatar()}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control">
                                                                <option <c:if
                                                                    test='${modelUser.getGender().equals("Male")}'>
                                                                    selected </c:if>>Male</option>
                                                                <option <c:if
                                                                    test='${modelUser.getGender().equals("Female")}'>
                                                                    selected </c:if>>Female</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" name="ls_province">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" name="ls_district">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" name="ls_ward">
