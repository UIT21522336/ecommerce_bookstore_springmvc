                            ...
                            <ul>
                                ...
                                <li><a href="#">Fiction</a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="./shop-cart.html">Biographical/a></li>
                                        <li><a href="./checkout.html">Classic Fiction</a></li>
                                    </ul>
                                </li>
                                <li><a href="#">Non-fiction</a>
                                    <ul class="dropdown">
                                        <li><a href="./product-details.html">Art, Fashion & Photography</a></li>
                                        <li><a href="./shop-cart.html">Business, Finance & Law</a></li>
                                        <li><a href="./checkout.html">Biography & True stories</a></li>
                                    </ul>
                                </li>
                                <li><a href="#">Children's</a>
                                    <ul class="dropdown">
                                        <li><a href="./product-details.html">Activity Books</a></li>
                                        <li><a href="./shop-cart.html">Baby & Toddler</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-7">
                        <div class="footer__about">
                            ...
                            <div class="footer__payment">
                                <a href="#"><img src="/resources/client/images/payment/payment-1.png" alt=""></a>
                                <a href="#"><img src="/resources/client/images/payment/payment-2.png" alt=""></a>
                                <a href="#"><img src="/resources/client/images/payment/payment-3.png" alt=""></a>
                                <a href="#"><img src="/resources/client/images/payment/payment-4.png" alt=""></a>
                                <a href="#"><img src="/resources/client/images/payment/payment-5.png" alt=""></a>
                            </div>
                        </div>
                    </div>
