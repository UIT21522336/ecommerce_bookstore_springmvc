                            ...
                            <div class="product__details__text">
                                ...
                                <div class="product__details__button">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <form:form action="/add-to-cart-from-product-details/${product.id}"
                                                method="POST" modelAttribute="cartDetailsModel">
                                                <div class="quantity">
                                                    <span>Quantity:</span>
                                                    <div class="pro-qty">
                                                ...
                                                <div style="display:none;">
                                                    <form:input path="quantity" class="cartDetailsModel_quantity"
                                                        value="1" />
                                                </div>
                                                <button style="all:unset;cursor:pointer"><a class="cart-btn"><span
