                        ...
                        <div class="col-lg-12">
                            <div class="breadcrumb__links">
                                ...
                                <a href="/products/${category}"
                                    style="text-transform: capitalize;">${categoryDisplayName.toLowerCase()}</a>
                                <span
                                    style="text-transform: capitalize;">${categoryDetailsDisplayName.toLowerCase()}</span>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="pagination__option">
                                        <c:if test="${1 < currentPage}">
                                            <a
                                                href="/products/${categoryName}/${categoryDetailName}?page=${currentPage-1}"><i
                                                    class="fa fa-angle-left"></i></a>
                                        </c:if>
                                        <c:forEach begin="1" end="${totalPages}" varStatus="status">
                                            <a href="/products/${categoryName}/${categoryDetailName}?page=${status.index}"
